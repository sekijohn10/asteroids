 ...
 *
 * Timothy Johnson:
 *     I have added the following functions to uiDraw.h:
 *       void drawScore(), void drawLives(), void drawLevel()
 *       void drawPause(), void drawPassword(), void drawPasswordResult()
 *       void displayPassword(), void drawWeaponAvailable(), void drawMenu()
 *       void drawHowTo(), void drawHighScore(), void drawGameOver()
 *       void drawBlueStar(), void drawWhiteStar(), void drawRedDot().
 *     I have also made some minor adjustments to original functions.
 ************************************************************************/
